...
link="https://raw.githubusercontent.com/tunel44/script/main"
# [ Warna ]
red='\e[1;31m'
green='\e[0;32m'
cyan='\e[0;36m'
...
clear
#IZIN=$( curl https://raw.githubusercontent.com/tunel44/ip/main/ip | grep $MYIP )
IZIN=$(curl -s https://raw.githubusercontent.com/tunel44/ip/main/ip | grep "$MYIP" | awk '{ print $4 }')
if [ $MYIP = $IZIN ]; then
...
echo "Telegram t.me/sedia_vps_sc_akun_paket_tembak"
exit 1
fi
clear
...
figlet -k Vnz | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1' && figlet -k Hysteria | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1'
echo "───────────────────────────────────────────────────────────────────────•"
